...
document.addEventListener(SAVED_EVENT, () => {
  ...
  elementCustomAlert.classList.add("alert-disimpan");
...
document.addEventListener(MOVED_EVENT, () => {
  const elementCustomAlert = document.createElement("div");
  elementCustomAlert.classList.add("alert-dipindah");
  elementCustomAlert.innerText = "🛒 Buku Berhasil Dipindah❕";
...
document.addEventListener(DELETED_EVENT, () => {
  const elementCustomAlert = document.createElement("div");
  elementCustomAlert.classList.add("alert-hapus");
...
const footer = document.getElementById("hello-footer");
footer.addEventListener("click", function () {
  const elementCustomAlert = document.createElement("div");
  elementCustomAlert.classList.add("alert-footer");
  elementCustomAlert.innerText = " Penuh ❤️ dari nanda";
...
const logoaturbuku = document.getElementById("atur-buku");
logoaturbuku.addEventListener("click", function () {
  const elementCustomAlert = document.createElement("div");
  elementCustomAlert.classList.add("alert-aturbuku");
  elementCustomAlert.innerText = " halo selamat datang di website atur buku";
